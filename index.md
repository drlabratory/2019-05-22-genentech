...
<div id="sql"> {% comment %} Start of 'SQL' section. {% endcomment %}
  <h3>SQL</h3>
  <p>
    SQL is a specialized programming language used with databases. We use a simple database 
    manager called <a href="https://www.sqlite.org/">SQLite</a> in our lessons. We will use 
    the <a href="https://sqlitebrowser.org/">DB Browser for SQLite</a> program to 
    communicate with the database manager. This program is available in all platform, download 
    the latest version of the program (3.11.2) through 
